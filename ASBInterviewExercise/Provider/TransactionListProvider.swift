...
protocol TransactionListProviderProtocol: AnyObject {
    var delegate: TransactionListProviderDelegate? { set get }
    func fetchTransactionList()
}

class TransactionListProvider: TransactionListProviderProtocol {
